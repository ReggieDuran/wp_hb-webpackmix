...
window.onload = function () {
  setTimeout(function () {
    ...
    var noScollJs = document.querySelector('.no-scroll_js');
...
window.onresize = reportWindowSize; // Function lists.

function navToggle() {
  var menuHamburder = document.getElementById('menu-hamburger');
